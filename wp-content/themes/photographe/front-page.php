    ...
    ?>
            <div class="photo-overlay">
                ...
                <div class="show_photo_icon" data-link="<?php echo get_permalink(get_the_ID()); ?>">
                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/icones/cross.svg" alt="Oeil">
                </div>

                <div class="show_lightbox_icon lightbox_open open-lightbox" data-post-title="<?php echo $title; ?>" data-post-date="<?php echo get_the_date('Y'); ?>" data-post-id="<?php echo get_the_ID(); ?>" data-post-term="<?php if ($terms_post) {
                                                                                                                                                                                                        echo $terms_post[0]->name;
                                                                                                                                                                                                    } ?>" data-image-path="<?php echo $thumbnail_url; ?>">

                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/fullscreen.png" alt="Plein écran">
